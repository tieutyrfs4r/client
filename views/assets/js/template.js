...
$(document).on('click', function(event) {
    ...
    if (!sidebar.is(event.target) && sidebar.has(event.target).length === 0 && !menuToggle.is(event.target) && !menuToggle.has(event.target).length) {
...
$(function() { 
    ...
    if (currentTheme) {
        ...
        var imagesLogo = document.querySelectorAll('.logo-img');

        if (currentTheme === 'dark') {
           toggleSwitch.checked = true;
           for(var i = 0; i < imagesLogo.length; i++) {
               imagesLogo[i].setAttribute('src', '/front/images/logo-light.png');
               imagesLogo[i].setAttribute('srcset', '/front/images/logo2x-light.png 2x');
           }
            // <img src="/front/images/logo.png" srcset="/front/images/logo2x.png 2x" alt="logo" class="logo-img">
        }
    ...
    function switchTheme(e) {
        ...
        if (e.target.checked) {
            ...
            for(var i = 0; i < imagesLogo.length; i++) {
                imagesLogo[i].setAttribute('src', '/front/images/logo.png');
                imagesLogo[i].setAttribute('srcset', '/front/images/logo2x.png 2x');
            }
        }    
    }
    function switchHc(e) {
